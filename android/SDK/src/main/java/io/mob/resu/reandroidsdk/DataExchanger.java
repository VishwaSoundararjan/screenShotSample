...
class DataExchanger {
    ...
    public static ArrayList<JSONObject> fieldCaptureList = new ArrayList<>();
        ...
        try {
            ...
            if (AppConstants.SDK) {
                if (requestType.equalsIgnoreCase("POST")) {
                    ...
                    if(finalUrl=="https://mobis.resu.io/Home/apiKeyValidation") {
                        if (modelResponseData.getFieldTrackValues() != null) {
                            JSONArray fieldList = modelResponseData.getFieldTrackValues();
                            if (fieldList != null) {
                                for (int i = 0; i < fieldList.length(); i++) {
                                    JSONObject fieldObject = fieldList.optJSONObject(i);
                                    if (fieldObject != null) {
                                        fieldCaptureList.add(fieldObject);
                                    }
                                }
                            }
                        }
