...
//
// // import 'DialogNavigationManager.dart';
...
//   }
//
//   Future<void> storeListInSharedPreferences(BuildContext context, String screenName) async {
//     //final prefs = await SharedPreferences.getInstance();
//     var convertedFormat = "$widgetIdentifiers";
//    // await prefs.setString(screenName, convertedFormat);
//     debugPrint("SCREENNAME: $screenName");
//
//     //debugPrint("Inside SharedPrefs: ${prefs.getString(screenName)}");
//
//   }
//
...
//
//     try{
//       GestureBinding.instance.pointerRouter.removeGlobalRoute(globalEvent);
//
//     } catch(e) {
//       debugPrint("GestureBinding not added yet");
//     }
//
//
...
//     widgetList = [];
//     widgetIdentifiers.clear();
//     _traverseWidget(context, widgets);
//     storeListInSharedPreferences(context, screenName);
//
//     debugPrint("widgetList: $widgetList");
//     return widgetList;
//   }
//
...
//       //Get ViewId
//
//         mapWidgetData["viewId"] = "${wid?.decoration?.labelText}";
//       }
//
//
...
//       //     mapWidgetData["viewId"] = "${text.data}GestureDetector";
//       //   }
//       //
//       //   break;
...
//           mapWidgetData["viewId"] = "${text.data}Btn";
//         }
//         ///assigning [mapWidgetData] Map to [widgetList] List
//         // widgetList.add(mapWidgetData);
//
...
//           mapWidgetData["viewId"] = "${text.data}FlBtn";
//         } else if(wid.child is Icon) {
//           var icon = wid.child as Icon;
//           mapWidgetData["viewId"] = "${icon.icon}FlBtn";
//         }
//         ///assigning [mapWidgetData] Map to [widgetList] List
//         // widgetList.add(mapWidgetData);
//
...
//       //     widgetContexts.add(context);
//       //
//       //     var wid = currentWidget as Radio;
//       //     category=currentWidget.runtimeType.toString();
//       //     ///gets x,y position and height and width of current widget
//       //     getWidgetPosition(context);
//       //     ///assigning values to map[mapWidgetData]
...
//       //     mapWidgetData["translationY"] = translationY;
//       //
//       //     mapWidgetData["viewId"] = wid.hashCode;
//       //
//       //     debugPrint("RadioViewId: ${wid.hashCode}");
//       //
//       //     ///assigning [mapWidgetData] Map to [widgetList] List
//       //     widgetList.add(mapWidgetData);
//       //
...
//             var text = wid.child as Text;
//             debugPrint("InkWellText: ${text.data}");
//             mapWidgetData["viewId"] = "${text.data}InkWell";
//           }
//
//           ///assigning [mapWidgetData] Map to [widgetList] List
//           // widgetList.add(mapWidgetData);
